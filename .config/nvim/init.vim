"let g:python_host_prog = system('$(brew --prefix)/bin/python2.7')
"let g:python3_host_prog = system('$(brew --prefix)/bin/python3.6')
"let g:ruby_host_prog = system('$(brew --prefix)/bin/ruby')


if has('mac')
  let g:python_host_prog = expand('/usr/local/bin/python2.7')
  let g:python3_host_prog = expand('/usr/local/bin/python3.6')
  let g:ruby_host_prog = expand('/usr/local/bin/ruby')
elseif has('unix')
  let g:python_host_prog = expand('/home/linuxbrew/.linuxbrew/bin/python2.7')
  let g:python3_host_prog = expand('/home/linuxbrew/.linuxbrew/bin/python3.6')
  let g:ruby_host_prog = expand('/home/linuxbrew/.linuxbrew/bin/ruby')
endif


let g:nvim_home = '~/.config/nvim'
if filereadable(expand(g:nvim_home .  '/echo.vim'))
  execute 'source ' . expand(g:nvim_home .  '/echo.vim')
endif
...
nnoremap <F2> <Cmd>CocCommand explorer<CR>
